...
const ArchiveMonolith: React.FC = () => {
  ...
  const volumes = [
    { vol: 'VOLUME 05', issue: '08', date: 'AUG 2026', img: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?q=80&w=2000' },
    { vol: 'VOLUME 05', issue: '07', date: 'JUL 2026', img: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?q=80&w=2000' },
    { vol: 'VOLUME 05', issue: '05', date: 'MAY 2026', img: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?q=80&w=2000' },
    { vol: 'VOLUME 05', issue: '04', date: 'APR 2026', img: 'https://images.unsplash.com/photo-1500673922987-e212871fec22?q=80&w=2000' }
  ];
